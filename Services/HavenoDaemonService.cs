...
public abstract class HavenoDaemonServiceBase : IHavenoDaemonService
{
    ...
    public HavenoDaemonServiceBase(IHavenoWalletService walletService, IHavenoVersionService versionService, IHavenoAccountService accountService, 
        string daemonPath, ILogger<IHavenoDaemonService> logger)
    {
